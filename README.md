...
| `otelURLSessionInstrumentationEnabled`     | Bool     | No        | Whether to enable OpenTelemetry's URLSession instrumentation. (overrides `urlSessionInstrumentationEnabled`). (default: true)                              |
