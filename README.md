...
| `serviceName`        | String?                        | No        | Name of your application. This determines the Honeycomb service to send data to, and also appears as the contents of the `service.name` resource attribute.|
